...
\begin{longtable}{|c|p{7cm}|c|c|}
    ...
    \hline
    8 & User Following: Users can follow other users for a personalized feed of questions. & Medium & $\square$\\
    \hline
    9 & Explore Page: A curated page showcasing a collection of questions for users to explore. & Low & $\square$\\
    \hline
    10 & OCR Integration: Implement Optical Character Recognition (OCR) for efficient conversion of printed or handwritten text into digital content. & Low & $\text{\rlap{$\checkmark$}}\square$\\
    \hline
    11 & SQLite Data Cache: Implement Data Caching to prevent overloading of Online Database & Medium & $\text{\rlap{$\checkmark$}}\square$\\
    \hline
    12 & Search: Efficient Searching for Users/Questions/tags & Medium & $\text{\rlap{$\checkmark$}}\square$\\
    \hline
    13 & Questions and Answer Display & High & $\text{\rlap{$\checkmark$}}\square$\\
    \hline
    14 & Color Scheme and theming & Low & $\square$\\
    \hline
